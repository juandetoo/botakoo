...
Usa ${prefix}verify para verificarte y poder usar el bot.`
				...
				num = anu.participants[0]
				teks = `Que bueno que te fuiste pa @${num.split('@')[0]} ni te queriamos 👋`
				Lxa.sendMessage(mdata.id, teks, MessageType.text, {contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
  ...
  only: {
    ...
    ownerG: 'A este comando solo lo puede usar el dueño del grupo',
    ownerB: 'Este comando solo puede ser usado por el dueño del bot',
    admin: 'tenes que ser admin para este comando',
    Badmin: 'necesito ser admin para poder hacer eso :)',
...
//---Metadata stiker
			function addMetadata(packname, author) {	
				if (!packname) packname = 'botako'; if (!author) author = 'thiagonahuel';	
...
*〘 PORCENTAJE DE GAY〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}porcentajedegay(Nombre)*
┃ _Porcentaje de gay_
┗━━━━━━━━━━━━━━━━━━━━
